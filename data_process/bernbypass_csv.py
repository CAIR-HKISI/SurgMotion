...
if __name__ == "__main__":
    # 配置参数 - 您可以在这里修改路径
    img_path = "data/MultiBypass140/BernBypass70"
    train_pkl_path = "/data/wjl/MultiBypass140/labels/bern/labels_by70_splits/labels/train/1fps_100_0.pickle"
    val_pkl_path = "/data/wjl/MultiBypass140/labels/bern/labels_by70_splits/labels/val/1fps_0.pickle"
    test_pkl_path = "/data/wjl/MultiBypass140/labels/bern/labels_by70_splits/labels/test/1fps_0.pickle"
    output_dir = "data/MultiBypass140/BernBypass70"  # CSV文件输出目录
    hospital = "Bern"
    year = "2023"
