...
FNAME="configs/align_metric/vitl_origin_attentive_1group.yaml"
CKPT="/data/wjl/vjepa2/logs/cpt_vitl16-256px-32f_cooldown_lr1e-4/e0.pt"
LOG_DIR="logs/align_metric_clean"
mkdir -p "${LOG_DIR}"

MASTER_PORT=12333  python -m evals.main --fname  ${FNAME} \
                                        --checkpoint  ${CKPT} \
                                        --folder ${LOG_DIR} \
                                        --frames_per_clip 32 \
                                        --batch_size 32 \
