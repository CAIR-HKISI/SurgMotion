...
# ==========================================
# atlas probing 独立脚本（直接 sbatch 即可）
# 默认：
#   - 使用 cooldown_vitg-256px-64f_4epoch 作为 CKPTL_NAME
#   - 使用 vit_giant_xformers 作为 MODEL_NAME
#   - 日志写到 logs_test 下
# 可通过参数或环境变量覆盖：
#   sbatch atlas.sh 其他_ckpt 其他_model
#   CKPTL_NAME=xxx MODEL_NAME=yyy sbatch atlas.sh
# ==========================================

FNAME="atlas_probe_attentive_64f.yaml"
