#! /bin/bash
#SBATCH -o SLURM_Logs_surgenet/%j.out # Standard output log
#SBATCH -e SLURM_Logs_surgenet/%j.err # Standard error log
...
pip install metaformer

FNAME="surgenet_vitl_cholect50_ivt.yaml"
TASK="triplets"
