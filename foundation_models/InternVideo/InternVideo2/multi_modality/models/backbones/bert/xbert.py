...
try:
    ...
    # Copied from transformers.modeling_utils (it was removed in newer versions or moved)
    def apply_chunking_to_forward(forward_fn, chunk_size, chunk_dim, *input_tensors):
        ...
        Args:
            ...
            chunk_size (:obj:`int`):
                The chunk size of a chunked tensor: :obj:`input_tensors[i]`.
            chunk_dim (:obj:`int`):
                The dimension over which the `input_tensors` should be chunked.
            input_tensors (:obj:`Tuple[torch.Tensor]`):
                The input tensors of `forward_fn` which will be chunked
        Returns:
            :obj:`torch.Tensor`: A merged arg-max tensor of the chunks.
        """
        ...
        # inspect.signature exist since python 3.5 and is less finger print than this
        # but for backward compatibility with older versions we check it manually
        if chunk_size > 0:
            ...
            # apply forward fn to all chunked tuples
...
try:
    ...
    # Copied from transformers.modeling_utils (deprecated/removed in newer versions)
...
try:
    ...
    def prune_linear_layer(layer: nn.Linear, index: torch.LongTensor, dim: int = 0) -> nn.Linear:
        ...
        Args:
            layer (:obj:`torch.nn.Linear`): The linear layer to prune.
            index (:obj:`torch.LongTensor`): The indices to keep in the layer.
            dim (:obj:`int`, `optional`, defaults to 0): The dimension on which to keep the indices.
        Returns:
            :obj:`torch.nn.Linear`: The pruned layer as a new layer with ``requires_grad=True``.
        """
